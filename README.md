...
### Project Structure 
The project contains 2 main files; Health Insurance Analysis.ipynb  and app.py. It essentially allows an user to get an insurance quote based on their demographics attribute such as age, sex, bmi

**Health Insurance Analysis.ipynb** - The Jupyter Notebook file contains the full machine learning pipeline including data preprocessing, including exploratory analysis and encoding categorical variables such as sex, smoker status and region. It additionally, stores Linear Regression, Polynomial Regression and Random Forest models training and evaluation. The best model is selected and saved based on performance.
...
### Model Information
- **Dataset:** Kaggle Insurance Dataset (csv file)
- **Models Tested:** Linear Regression, Polynomial Regression, Random Forest.
  The models were evaluated on R2, Mean Absolute Error and Mean Squared Root Absolute Error scores.
